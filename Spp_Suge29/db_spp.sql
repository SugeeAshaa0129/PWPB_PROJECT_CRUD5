...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2021 at 02:27 AM
...
(4, 'Suge', '202cb962ac59075b964b07152d234b70', 'admin'),
(5, 'Asha', '202cb962ac59075b964b07152d234b70', 'petugas');
...
('00236252', '236252', 'Sugeri Ashari Ramdhani', 1, 'wangun', '08953726272', 2, 4, 'default.jpg'),
('009254372', '9254372', 'Sugesa Rams', 2, 'Langit ke 7, Rahmatullah Rt01/01', '08962536252', 6, 5, 'default.jpg');
...
--
ALTER TABLE `pembayaran`
  MODIFY `id_pembayaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6192;
